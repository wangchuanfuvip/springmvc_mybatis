...
public class MyLucene {
    ...
    public void testIndex1() throws Exception {
        ...
        document.add(new TextField("sellPoint", "下单送12000毫安移动电源！双3.5英寸魔焕炫屏，以非凡视野纵观天下时局，尊崇翻盖设计，张弛中，尽显从容气度！",
                Store.YES));
    ...
    public void testIndex2() throws Exception {
        ...
        Document document = new Document();// 商品数据
        document.add(new LongField("id", 562379L, Store.YES));
        document.add(new TextField("title", "三星 W999 黑色 电信3G手机 双卡双待双通 传智播客", Store.YES));
        document.add(new TextField("sellPoint", "下单送12000毫安移动电源！双3.5英寸魔焕炫屏，以非凡视野纵观天下时局，尊崇翻盖设计，张弛中，尽显从容气度！",
                Store.YES));
        document.add(new LongField("price", 299000L, Store.YES));
        document.add(new LongField("num", 99999L, Store.YES));
        document.add(new StringField("image",
                "http://image.taotao.com/jd/4ef8861cf6854de9889f3db9b24dc371.jpg", Store.NO));
    ...
    public void testQuery2() throws Exception {
        ...
        Query query = parser.parse("手机"); // 构造查询对象，分词查询
    ...
    public void testFuzzyQuery() throws Exception {
        Query query = new FuzzyQuery(new Term("title", "aawla"));
        showQuery(query);
    }
    ...
    public void testBooleanQuery() throws Exception {
        ...
        query.add(new FuzzyQuery(new Term("title", "apale")), Occur.MUST);
        showQuery(query);
    }
